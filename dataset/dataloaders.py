...
def get_dataloaders(
    ...
    train_sampler = WeightedRandomSampler(
        [weights[i] for i in train_dataset.indices], num_samples=train_len
    )
    val_sampler = WeightedRandomSampler(
        [weights[i] for i in val_dataset.indices], num_samples=val_len
    )
    test_sampler = WeightedRandomSampler(
        [weights[i] for i in test_dataset.indices], num_samples=test_len
    )
